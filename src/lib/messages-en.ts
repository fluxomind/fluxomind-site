...
export const PURPOSE_LINE_EN =
  'For 30 years, companies have adapted to their software. We exist to flip that: software that molds itself to your business — and works for it.';
...
export const NEGATION_EN = {
  ...
  is: "It's a self-operating app: it builds itself from your problem, runs the day-to-day — and hands off the sensitive calls to a human.",
} as const;

export const DEFINITION_EN =
  "A self-operating app is an app that builds itself from your business problem, runs the process day-to-day — and escalates to a human when a case calls for it. It's the third category of software, between rigid systems that force the company to adapt and human consulting that doesn't scale: software that molds itself to the business and works for it.";
...
export const FACES_EN = [
  ...
  { label: 'Connections', q: 'What does it talk to?', gloss: 'WhatsApp, email, API, your systems' },
